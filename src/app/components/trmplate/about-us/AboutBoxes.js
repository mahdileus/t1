const services = [
  {
    ...
    description:
      "طراحی سایت‌های کاملاً اختصاصی با وردپرس که کاملا حرفه‌ای سفارشی‌سازی شده‌اند. سایت‌های ما ریسپانسیو، بهینه برای موتورهای جستجو و با تجربه کاربری بالا هستند تا کسب‌وکار شما را به بهترین شکل آنلاین معرفی کنند.",
    icon: (
      <svg
      ...
      >
        <g id="shopping-cart-svgrepo-com" transform="translate(-1.25 -1.25)">
          <path
            ...
            transform="translate(11.176 14.971)"
            fill="#ff9436"
          />
          <path
            id="Path_2073"
            ...
            transform="translate(4.428 14.971)"
            fill="#ff9436"
          />
          <path
            id="Path_2074"
          ...
          <path
            ...
            transform="translate(2.319 6.326)"
            fill="#ff9436"
          />
        </g>
      </svg>
  ...
  },
  {
    ...
    description:
      "توسعه برنامه‌های تحت وب و اپلیکیشن‌های مدرن با زبان‌های PHP، Laravel، React و Node.js. کدنویسی ما مقیاس‌پذیر، بهینه و مطابق با استانداردهای روز است تا پروژه شما پایدار، امن و قابل توسعه باقی بماند.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="30.439"
  ...
  },
  {
    title: "سئو (SEO)",
    description:
      "ارائه خدمات کامل سئو شامل تحلیل کلمات کلیدی، بهینه‌سازی ساختار سایت و محتوا، افزایش سرعت بارگذاری و بهبود رتبه در گوگل تا کسب‌وکار شما در نتایج جستجو بیشتر دیده شود و ترافیک هدفمند جذب کند.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="40"
      ...
      >
        <g id="code-circle-svgrepo-com" transform="translate(-2 -2)">
          <path
            id="Path_2062"
            data-name="Path 2062"
            d="M22,42A20,20,0,1,0,2,22,20,20,0,0,0,22,42Z"
            fill="#ff9436"
            opacity="0.4"
          />
          <path
            ...
            transform="translate(3.218 7.115)"
            fill="#ff9436"
          />
          <path
            id="Path_2064"
            ...
            transform="translate(13.112 7.115)"
            fill="#ff9436"
          />
          <path
            id="Path_2065"
            ...
            transform="translate(8.168 6.752)"
            fill="#ff9436"
          />
        </g>
      </svg>
  ...
  },
  {
    ...
    description:
      "اجرای کمپین‌های تبلیغاتی حرفه‌ای در گوگل و شبکه‌های اجتماعی با هدف افزایش فروش و آگاهی برند. با تحلیل دقیق بازار و هدف‌گذاری هوشمند، بودجه تبلیغات شما به بهترین شکل مصرف شده و نتایج قابل اندازه‌گیری ارائه می‌شود.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="39.004"
      ...
      >
        <g id="presention-chart-svgrepo-com" transform="translate(-1.25 -1.25)">
          <path
            ...
            transform="translate(1.425 0.611)"
            fill="#ff9436"
            opacity="0.4"
          />
          <path
          ...
          <path
            ...
            transform="translate(4.883 12.822)"
            fill="#ff9436"
          />
          <path
            id="Path_2071"
            ...
            transform="translate(4.475 4.881)"
            fill="#ff9436"
          />
        </g>
      </svg>
...
export default function AboutBoxes() {
  return (
    <section className="py-16 font-yekan-bakh md:py-24">
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-extrabold leading-[1.7] text-primary md:text-4xl">
            خدمات <span className="text-secondery">تیوان</span>، از ایده تا
            موفقیت آنلاین
          </h2>

          <p className="mt-5 text-justify text-sm leading-8 text-gray-600 md:text-center md:text-base md:leading-9">
            ما در تیوان با ارائه مجموعه‌ای کامل از خدمات دیجیتال مارکتینگ، از
            طراحی وبسایت اختصاصی و برنامه‌نویسی پیشرفته گرفته تا سئو، تبلیغات و
            افزایش فروش، همراه شما هستیم تا کسب‌وکارتان را به شکلی حرفه‌ای در
            فضای آنلاین رشد دهید.
          </p>
        </div>

        <div className="mt-20 grid grid-cols-1 gap-x-8 gap-y-16 md:grid-cols-2 lg:grid-cols-4">
          {services.map(({ title, description, icon }) => (
            <article
              key={title}
              className="relative rounded-[2rem] border border-gray-100 bg-white px-6 pb-7 pt-16 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-secondery/30 hover:shadow-xl hover:shadow-secondery/10 motion-reduce:transform-none"
            >
              <span className="absolute right-1/2 top-0 flex size-24 translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-secondery/10 bg-[#fff3f0] shadow-lg shadow-secondery/10">
                {icon}
              </span>

              <h3 className="text-center text-lg font-extrabold leading-8 text-primary">
                {title}
              </h3>

              <p className="mt-5 rounded-3xl bg-gray-50 p-5 text-justify text-sm leading-7 text-gray-600">
                {description}
              </p>
            </article>
          ))}
